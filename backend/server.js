...
const dbUrl = `mongodb+srv://admin:admin@cluster0.hikglfo.mongodb.net/?retryWrites=true&w=majority`;
...
app.put("/books/:bookId", async (req, res) => {
    try {
        ...
        let book = await PostModel.findByIdAndUpdate({ _id: req.params.bookId }, req.body, {
            new: true,
        }).catch((err) => {
